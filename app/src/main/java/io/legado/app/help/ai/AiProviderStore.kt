...
object AiProviderStore {
    ...
    private fun mergeProvider(
        ...
        return default.copy(
            ...
            // 媒体生成（图片/视频）：保留用户在设置里的自定义项
            mediaProtocol = savedProvider.mediaProtocol,
            supportsImageGeneration = savedProvider.supportsImageGeneration,
            supportsVideoGeneration = savedProvider.supportsVideoGeneration,
            imageGenerationsPath = savedProvider.imageGenerationsPath,
            imageEditsPath = savedProvider.imageEditsPath,
            videoGenerationsPath = savedProvider.videoGenerationsPath,
            videoTaskPath = savedProvider.videoTaskPath,
            mediaTaskIdPath = savedProvider.mediaTaskIdPath,
            mediaStatusPath = savedProvider.mediaStatusPath,
            mediaResultPath = savedProvider.mediaResultPath,
            mediaErrorPath = savedProvider.mediaErrorPath,
            imageModel = savedProvider.imageModel,
            videoModel = savedProvider.videoModel
        )
    }
    ...
    private fun normalize(provider: AiProviderSetting): AiProviderSetting {
        return provider.copy(
            ...
            supportsVideoGeneration = provider.supportsVideoGeneration,
            imageGenerationsPath = provider.imageGenerationsPath,
            imageEditsPath = provider.imageEditsPath,
            videoGenerationsPath = provider.videoGenerationsPath,
            videoTaskPath = provider.videoTaskPath,
            mediaTaskIdPath = provider.mediaTaskIdPath,
            mediaStatusPath = provider.mediaStatusPath,
            mediaResultPath = provider.mediaResultPath,
            mediaErrorPath = provider.mediaErrorPath,
