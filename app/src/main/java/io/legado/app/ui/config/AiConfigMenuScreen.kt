...
internal fun AiConfigMenuScreen(
    ...
    Column(
        ...
        NgSettingsGroup {
            ...
            AiConfigMenuEntry(
                title = stringResource(R.string.ai_media_menu),
                summary = stringResource(R.string.ai_media_menu_summary),
                iconRes = R.drawable.ic_ai_capability_vision,
                onClick = { onOpenPage(AiConfigFragment.PAGE_MEDIA) }
            )
            AiConfigMenuEntry(
                title = stringResource(R.string.ai_media_library_menu),
                summary = stringResource(R.string.ai_media_library_menu_summary),
                iconRes = R.drawable.ic_ai_capability_vision,
                onClick = { onOpenPage(AiConfigFragment.PAGE_MEDIA_LIBRARY) }
            )
        }
    }
}
